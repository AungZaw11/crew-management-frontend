// src/features/appointment/components/FormActions.jsx
import React from "react";
import { useLanguage } from "../../../common/hooks/LanguageContext";

export default function FormActions({ isEditing, isLoading, onSave, onCancel }) {
  const { t } = useLanguage();
  ...
  return (
    <div className="mt-8 flex items-center justify-end gap-5">
      ...
      <button
        ...
        disabled={isLoading}
      >
        {isLoading ? "Saving..." : isEditing ? t("update") || "Update" : t("save") || "Save"}
      </button>
    </div>
  );
}