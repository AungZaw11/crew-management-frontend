        ...
        <>
          ...
          <div>
            {data.map((row, i) => (
              <div
                key={i}
                className="grid grid-cols-[1.5fr_1.5fr_1fr_3fr_2fr_1fr] items-center border-b border-[#F1F5F9] px-5 py-3.5 font-inter text-xs cursor-pointer hover:bg-gray-50 transition-colors"
